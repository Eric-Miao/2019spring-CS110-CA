...
(file_locations,'reference_output/alu-add-ref.out'), "")),
  ...
  ("ALU set, sub test", "student_output/alu-set-sub-student.out", TestCase(os.path.join(file_locations,'alu_tests/alu-set-sub.circ'), os.path.join(file_locations,'reference_output/alu-set-sub-ref.out'), "")),
...
("ALU comprehensive test", "student_output/alu-comprehensive-student.out", TestCase(os.path.join(file_locations,'alu_tests/alu-comprehensive.circ'), os.path.join(file_locations,'reference_output/alu-comprehensive-ref.out'), "")),
  ...
  ('ALU cnto', "student_output/alu-cnto-student.out", TestCase(os.path.join(file_locations,'alu_tests/alu-cnto.circ'), os.path.join(file_locations,'reference_output/alu-cnto-ref.out'), "")),
  #tests added by huzy above
