...
.LFB502:
	...
	movq	%rax, -416(%rbp)
	movq	-416(%rbp), %rax
	movupd	(%rax), %xmm0 //__m128d _mm_loadu_pd
	movaps	%xmm0, -352(%rbp)
	leaq	-48(%rbp), %rax
	addq	$16, %rax
	movq	%rax, -424(%rbp)
...
.L4:
	...
	movq	-368(%rbp), %rax
	movups	%xmm0, (%rax)
	//below is to start print the result
	movsd	-32(%rbp), %xmm4
	movsd	-48(%rbp), %xmm3
	movsd	-64(%rbp), %xmm2
	movsd	-80(%rbp), %xmm1
