...
void heap_insertF (heap_t *h, node_t *n);
node_t *heap_extractF (heap_t *h);
void heap_updateF (heap_t *h, node_t *n);
void heap_insertR (heap_t *h, node_t *n);
node_t *heap_extractR (heap_t *h);
void heap_updateR (heap_t *h, node_t *n);
